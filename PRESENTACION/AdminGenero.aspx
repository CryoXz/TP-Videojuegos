        ...
        <div class="container">
            ...
            <div class="row">
                <div class="form-inline">
                   <asp:Label ID="lblGenero" runat="server" Text="INGRESE EL NOMBRE DEL NUEVO GENERO:"></asp:Label>
                    &nbsp;
                    <asp:TextBox ID="txtNombreGenero" runat="server" CssClass="rounded" onkeypress="if (event.keyCode==13) return false;"></asp:TextBox>                   
                    &nbsp;                
