...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-10">
        ...
        <div class="col-lg-2">
            ...
            <asp:GridView ID="GrdPlataformas" runat="server" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowDeleting="GrdPlataformas_RowDeleting" OnRowCancelingEdit="GrdPlataformas_RowCancelingEdit" OnRowEditing="GrdPlataformas_RowEditing" OnRowUpdating="GrdPlataformas_RowUpdating">
            </asp:GridView>
