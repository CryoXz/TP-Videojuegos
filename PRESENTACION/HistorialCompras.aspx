    ...
    <div class="container-fluid" style="background-color:crimson">
        ...
        <div class="main row">
            ...
            <div class="col-lg-8" style="background-color:white">
                <div class="container">   
                <asp:GridView ID="grdVentas" CssClass="Grid" runat="server" ShowHeader="False" AutoGenerateColumns="False">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="VER DETALLE">
                            <ItemTemplate>
                                <asp:Button ID="Button1" class="btn btn-danger" runat="server" Text="VER DETALLE" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
